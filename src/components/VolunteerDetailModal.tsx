...
const VolunteerDetailModal: React.FC<VolunteerDetailModalProps> = ({ volunteer, isOpen, onClose }) => {
        ...
        <div className="pt-20 p-6">
          <div className="text-center mb-6">
            ...
            <div className="inline-block px-3 py-1 bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 text-sm rounded-full">
              {getCategoryLabel(volunteer.category)}
            </div>
          </div>
          ...
          <div className="mb-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center">
              ...
              <span className="text-gray-700 dark:text-gray-300">
                Team Member Since: {new Date(volunteer.joinedAt).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long'
                })}
              </span>
